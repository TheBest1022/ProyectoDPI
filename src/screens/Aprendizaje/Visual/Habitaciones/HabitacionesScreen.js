...
import {dataHabitaciones } from "../../../../sample/Visual";
...
function HabitacionesScreen() {
  ...
  const renderData = () => {
    return (
      <View>
        {dataHabitaciones.map(({ module }, index) => (
    ...
    <Layout>
      <ScrollView>
        <View style={style.container}>
          ...
          <Text style={style.text}> HABITACIONES DE LA CASA </Text>
...
export default HabitacionesScreen;
